...
I am lucky to be able to acknowledge that there are still hard problems in computer security [(examples)](https://github.blog/author/mymo/), and that there are awesome people working on them, see the [KSPP](https://github.com/KSPP)! There is a roundtable session on preventions for recent exploits at the [2025 Linux Security Summit](https://events.linuxfoundation.org/linux-security-summit-north-america/).
